...
public class HuaweiCloudSecurityGroup implements SecurityGroup {
  private String type = HuaweiCloudProvider.ID;
  private String cloudProvider = HuaweiCloudProvider.ID;
  ...
  public HuaweiCloudSecurityGroup(
      String id,
      String name,
      String region,
      String accountName,
  ...
  public SecurityGroupSummary getSummary() {
    return new HuaweiCloudSecurityGroupSummary(name, id, vpcId);
  }
