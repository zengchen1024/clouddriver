...
import com.netflix.spinnaker.clouddriver.huaweicloud.deploy.ops.DestroyServerGroupOperation
...
@Component
class DestroyServerGroupConverter extends AbstractAtomicOperationsCredentialsSupport {

  @Override
  AtomicOperation convertOperation(Map input) {
    new DestroyServerGroupOperation(convertDescription(input))
  }
