...
abstract class AbstractEnableDisableInstancesInDiscoveryDescriptionValidator extends AbstractHuaweiCloudDescriptionValidator<HuaweiCloudInstancesDescription> {
