...
import com.netflix.spinnaker.clouddriver.huaweicloud.deploy.ops.DisableServerGroupOperation
...
@Component
class DisableServerGroupConverter extends AbstractAtomicOperationsCredentialsSupport {

  @Override
  AtomicOperation convertOperation(Map input) {
    new DisableServerGroupOperation(convertDescription(input))
  }
