...
@Component
class RegisterInstancesToLBDescriptionValidator extends AbstractDescriptionValidator<InstancesRegistrationDescription> {
  String context = "registerInstancesToLBDescription"
