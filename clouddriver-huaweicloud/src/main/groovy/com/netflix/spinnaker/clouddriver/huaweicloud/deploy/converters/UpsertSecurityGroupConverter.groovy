...
import com.netflix.spinnaker.clouddriver.huaweicloud.deploy.ops.UpsertSecurityGroupOperation
...
@Component
class UpsertSecurityGroupConverter extends AbstractAtomicOperationsCredentialsSupport {
  @Override
  AtomicOperation convertOperation(Map input) {
    new UpsertSecurityGroupOperation(convertDescription(input))
  }

  @Override
  UpsertSecurityGroupDescription convertDescription(Map input) {
    AtomicOperationConverterHelper.convertDescription(input, this, UpsertSecurityGroupDescription)
  }
}
