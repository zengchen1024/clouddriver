...
@Component
class DestroyServerGroupDescriptionValidator extends AbstractDescriptionValidator<ServerGroupDescription> {
  String context = 'destroyServerGroupDescriptionValidator'
