...
class DeleteLoadBalancerDescriptionValidator extends AbstractDescriptionValidator<LoadBalancerDescription> {
  String context = 'deleteLoadBalancerDescriptionValidator'

  @Override
  void validateMore(List priorDescriptions, LoadBalancerDescription description, Errors errors) {
  }
}
