...
import com.netflix.spinnaker.clouddriver.huaweicloud.deploy.ops.DeleteSecurityGroupOperation
...
@Component
class DeleteSecurityGroupConverter extends AbstractAtomicOperationsCredentialsSupport {
  @Override
  AtomicOperation convertOperation(Map input) {
    new DeleteSecurityGroupOperation(convertDescription(input))
  }

  @Override
  DeleteSecurityGroupDescription convertDescription(Map input) {
    AtomicOperationConverterHelper.convertDescription(input, this, DeleteSecurityGroupDescription)
  }
}
